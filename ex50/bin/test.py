...
・ログインする
・指定したカテゴリ（このプログラムだとキャリア・教育）にアクセスする
・そのカテゴリの記事のURLをすべて取得する
・すべてのURLにアクセスし、その記事をピックした人全員のコメントをいいねする
・すべての記事のコメントにいいねしたら終了
...
print(str(numberOfPage) + "タイムラインの記事を全部いいねしました。プログラムを終了します。")
browser.quit
